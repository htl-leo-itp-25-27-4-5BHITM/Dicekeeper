  ...
  function renderPlayerView() {
    content.innerHTML = `
      <div class="preview">
        ...
        <div class="players-title">Beigetretene Spieler</div>
        <div class="players-horizontal">${renderPlayersCompact()}</div>
        ${campaign.mapImagePath ? `<div class="map-section" style="margin-top:16px"><div class="players-title" style="margin-bottom:10px">Kampagnenkarte</div><img src="${esc(resolveMapUrl(campaign.mapImagePath))}" alt="Karte" style="width:100%;max-height:300px;object-fit:cover;border-radius:12px;" /></div>` : ''}
      </div>
      <div class="footer">
  ...
  function renderDMView() {
    content.innerHTML = `
      ...
      <div class="form-group"><label>Karte</label>
        ...
        ${campaign.mapImagePath ? `<div class="map-section" style="margin-top:12px"><img id="cdMapImg" src="${esc(resolveMapUrl(campaign.mapImagePath))}" alt="Karte" style="width:100%;max-height:300px;object-fit:cover;border-radius:12px;" /></div>` : '<div class="map-section" style="display:none;margin-top:12px"><img id="cdMapImg" src="" alt="Karte" style="width:100%;max-height:300px;object-fit:cover;border-radius:12px;" /></div>'}
      </div>
